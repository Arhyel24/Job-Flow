...
const onboardingData = [
  {
    ...
    description:
      "Centralize all your job search activities in a single, easy-to-use dashboard.",
    icon: "briefcase",
  },
  {
  ...
  },
  {
    ...
    description:
      "Experience full features risk-free. Your data stays with you forever.",
    icon: "star",
  },
];
        ...
        {onboardingData.map((_, index) => (
          <MotiView
            ...
            animate={{
              ...
              backgroundColor:
                index === activeIndex ? theme.primary : theme.text.secondary,
            }}
