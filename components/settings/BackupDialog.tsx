  ...
  useEffect(() => {
    const prepareBackup = async () => {
      ...
      try {
        ...
        const backupData = entries.reduce<Record<string, string>>(
          (acc, [key, value]) => {
            if (value !== null) {
              acc[key] = value;
            }
        ...
        const fileSize =
          fileInfo.exists && fileInfo.size ? fileInfo.size : null;
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        Safely store your job application data locally or in your Google Drive
        account. Google Drive backup allows you to restore your data if you
        change devices.
      </Text>
        ...
        <>
          ...
          {user ? (
            <View style={styles.section}>
              ...
              <Button
                title={
                  uploadingToDrive ? "Uploading..." : "Backup to Google Drive"
                }
